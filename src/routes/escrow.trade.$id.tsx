    ...
    <div className="space-y-6">
      <section className="surface rounded-3xl p-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            <div className="text-xs uppercase tracking-[0.2em] text-muted-foreground">Trade details</div>
            <h1 className="text-3xl font-semibold">Escrow trade #{t.id.slice(0,8)}</h1>
            <p className="mt-2 text-sm text-muted-foreground">Manage the specific escrow transaction, confirm deposits, sign terms, and release funds with Telegram synchronized chat.</p>
          </div>
